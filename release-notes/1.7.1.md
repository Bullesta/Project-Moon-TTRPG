...
Manifest URL: https://asacolips-artifacts.s3.amazonaws.com/projectmoonttrpg/1.7.1/system.json

**Combatible Foundry versions**: v11

## Features

- Removed v10 compatibility to support fixing deprecation warnings in v11. Project Moon TTRPG 1.7.0 is now the final v10 release for the system.
