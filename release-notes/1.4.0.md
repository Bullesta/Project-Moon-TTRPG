...
Manifest URL: https://gitlab.com/asacolips-projects/foundry-mods/projectmoonttrpg/-/raw/1.4.0/system.json

## Features

Added improved support for Homebrew World thanks to @mangofeet! The following new system settings have been added:

- Setting to ignore default TTRPG compendium data for purposes of auto-filling a character sheet at creation time.
